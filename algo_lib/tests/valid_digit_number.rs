...
Example 1:
    ...
    Output: true
    Explanation:
        The number contains digit 0 at index 1. 
        It does not start with 0, so it satisfies both conditions. 
...
Example 2:
    ...
    Output: false
    Explanation:
        The number starts with 2, which violates the condition. 
...
Example 3:
    ...
    Output: false
    Explanation:
        The number does not contain digit 1. 
        Thus, the answer is false.
